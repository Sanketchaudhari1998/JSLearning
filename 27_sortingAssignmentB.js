class Employee {
  ...
  console.log(`---Task 1  Sort the 'arrayEmployees' in ascending order of Employee Id's -------`);
  ...
  console.log(`---Task 2  Sort the 'arrayEmployees' in ascending order of Employee department -------`);
  arrayEmployees.sort((emp1, emp2)=> {
  ...
  console.log(`---Task 3  Sort the 'arrayEmployees' in descending order of Employee salary -------`);
  arrayEmployees.sort((emp1, emp2)=> {
